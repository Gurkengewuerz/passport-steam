  ...
  steam.getPlayerSummaries({
    ...
    callback: function(err, result) {
      ...
      var profile = {
        ...
        profile: result.response.players[0].profileurl,
        possibleUsername: /id/.test(result.response.players[0].profileurl) == true ? result.response.players[0].profileurl.split('id/')[1].split('/')[0] : result.response.players[0].personaname.replace(/[^0-9a-z]/gi, ''),
        photos: [{
